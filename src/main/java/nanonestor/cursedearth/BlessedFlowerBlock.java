...
public class BlessedFlowerBlock extends FlowerBlock {
    ...
    public static final Block blessed_flower = new BlessedFlowerBlock(MobEffects.SATURATION, 7, Properties.ofFullCopy(Blocks.DANDELION), BlockBehaviour.Properties.ofFullCopy(Blocks.DANDELION).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
